...
<div class="row justify-content-center">
    <div class="col-lg-10">
        ...
        <div class="card mb-4 border-0 shadow-sm bg-white" style="border-radius: 15px;">
            <div class="card-header bg-white border-bottom py-3 d-flex justify-content-between align-items-center" style="border-radius: 15px 15px 0 0;">
                <h5 class="mb-0 fw-bold text-dark"><i class="fas fa-info-circle me-2 text-primary"></i>Detail Proyek</h5>
                @php
            ...
            <div class="card-body text-dark">
                <div class="row g-4">
                    ...
                    <div class="col-12"><hr class="text-muted my-0"></div>
                ...
                @if($pesanan->progres && $pesanan->progres->count() > 0)
                    <div class="timeline mt-3 px-2">
                        ...
                        @php
                            ...
                            if (str_contains($tahap, 'finishing')) {
                                $percent = 100;
                                ...
                                $percent = 40;
                            } elseif (str_contains($tahap, 'perancangan')) {
                                $percent = 20;
                            } else {
                                $percent = 100; // Default jika status lain
                            }
                        @endphp
                        
                        <div class="timeline-item pb-5 border-start ps-4 position-relative" style="border-color: #e9ecef;">
                            ...
                            <div class="p-3 rounded-3 shadow-sm bg-light border">
                                ...
                                <div class="progress my-2 bg-white border" style="height: 8px; border-radius: 10px;">
                                    <div class="progress-bar bg-success" role="progressbar" style="width: {{ $percent }}%"></div>
                                </div>

                                @if($prog->foto)
                                <div class="mt-3">
                                    <p class="text-muted small mb-1"><i class="fas fa-camera me-1"></i> Dokumentasi:</p>
                                    <a href="{{ asset('storage/progres/' . $prog->foto) }}" target="_blank" class="d-inline-block overflow-hidden rounded">
        ...
        <div class="text-center mb-5">
            ...
            <a href="https://wa.me/6281234567890?text=Halo%20Admin,%20saya%20mau%20tanya%20pesanan%20{{ $pesanan->kode_pesanan }}" target="_blank" class="btn btn-success rounded-pill px-4 shadow-lg hover-scale">
...
<style>
    ...
    .timeline-dot { top: 0px !important; left: -1px !important; }
